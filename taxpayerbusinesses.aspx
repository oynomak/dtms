<%@ Page Language="C#" MasterPageFile="~/mainmaster.master" AutoEventWireup="true"
    CodeFile="taxpayerbusinesses.aspx.cs" Inherits="taxpayerbusinesses" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="centerbox">
        <div class="headerlabel">
            ...
            <asp:Label ID="LblAddBusiness" runat="server" Font-Bold="True"></asp:Label>
        </div>
        <div>
        ...
        <div class="simplebordered">
            <table style="width: 100%">
                ...
                <tr>
                    <td valign="top">
                        <asp:TextBox ID="txtProfession" runat="server" Width="120px"></asp:TextBox>
                    </td>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <asp:Button ID="BtnAddBusiness" runat="server" Text=" Add " OnClick="BtnAddBusiness_Click" /></td>
                </tr>
                <tr>
                    <td>
        ...
        <div class="headerlabel">
            ...
            <asp:Label ID="LblBusinesss" runat="server" Font-Bold="True"></asp:Label>
        </div>
        <div class="simplebordered">
            <asp:Table ID="TblBusinesss" runat="server" Width="240px">
            </asp:Table>
        </div>
        <div class="simplebordered">
            <table>
                <tr>
                    <td>
                        ...
                        <asp:Button ID="BtnFinish" runat="server" OnClick="BtnFinish_Click" Text=" Finish" /></td>
                </tr>
            </table>
        </div>
    </div>
