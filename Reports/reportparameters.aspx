<%@ Page Language="C#" MasterPageFile="~/mainmaster.master" AutoEventWireup="true"
    CodeFile="reportparameters.aspx.cs" Inherits="Reports_reportparameters" Title="Untitled Page" %>
        ...
        <div class="simplebordered">
            <table>
                <tr>
                    ...
                    <td style="width: 131px; height: 51px;">
                    ...
                    <td style="width: 59px; height: 51px;">
                ...
                <tr>
                <td style="width: 91px">
                    <asp:HiddenField ID="HFReportName" runat="server" /><asp:HiddenField ID="HFDistrictID" runat="server" /><asp:HiddenField ID="HFSectorID" runat="server" /><asp:HiddenField ID="HFTaxTypeID" runat="server" />
                </td>
                </tr> 
            </table>
        </div>
