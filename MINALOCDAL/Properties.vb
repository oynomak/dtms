...
Public Class Properties
    ...
    Public Sub UpdateLocalServer(ByVal connection As String)
        Try
            ...
            For Each payer As [Property] In Me
    ...
    Public Sub LoadFromDistrict(ByVal connection As String, ByVal lastupdate As Date)
        ...
        Try
            ...
            cmd.CommandText = "GetNewProperties"
            ...
            Do While dr.Read
                ...
                With oProperyt
                    ...
                    .Amount = CDec(dr.GetValue(8))

                    .CellID = CShort(dr.GetValue(9))
    ...
    Public Sub Add(ByVal [Property] As [Property])
    ...
    Default Public Overloads ReadOnly Property Item(ByVal name As String) As [Property]
        ...
        Get
            ...
            For Each p_Properyt In Me
                ...
                If p_Properyt.PlotNumber = name Then
